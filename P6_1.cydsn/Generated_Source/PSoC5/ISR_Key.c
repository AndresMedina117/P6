...
{
    #ifdef ISR_Key_INTERRUPT_INTERRUPT_CALLBACK
        ISR_Key_Interrupt_InterruptCallback();
    #endif /* ISR_Key_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling ISR_Key_Start or ISR_Key_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after ISR_Key_Start or ISR_Key_StartEx has been called. 
